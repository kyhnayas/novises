...
const footerLinks = {
  ...
  legal: [
    { href: "/gizlilik", label: "Gizlilik Politikası & KVKK" },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Sakarya Adapazarı Devlet Hastanesi karşısında, güvenilir işitme sağlığı hizmetleri sunuyoruz.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  Güllük, Adnan Menderes Cd Sağlık Sk no:3<br />
                  Adapazarı / Sakarya
                </span>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Novises İşitme Cihazları. Tüm hakları saklıdır.
          </p>
