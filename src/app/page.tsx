...
const services = [
  ...
  },
  {
    ...
    title: "Bakım & Servis",
    desc: "Cihazınızın temizliği, bakımı ve teknik servisi için uzman desteği sunuyoruz.",
  },
];

const steps = [
  { num: "01", title: "Randevu Alın", desc: "Telefon veya form üzerinden randevu oluşturun." },
  { num: "02", title: "İşitme Testi", desc: "Uzman ekibimizle ücretsiz odyometri testinizi gerçekleştirin." },
  { num: "03", title: "Değerlendirme", desc: "Sonuçlarınızı birlikte inceleyerek size en uygun çözümü belirleyelim." },
  { num: "04", title: "Cihaz Uyumu", desc: "Seçilen cihazı size özel ayarlayıp takip sürecini başlatalım." },
];
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-brand-light via-white to-teal-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="section-subtitle">Sakarya'nın Güvenilir İşitme Merkezi</span>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-lg">
              ...
              kişiselleştirilmiş cihaz önerisi ve uzun vadeli bakım hizmeti sunuyoruz.
              Adapazarı Devlet Hastanesi karşısında, size yakın.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10 pt-8 border-t border-gray-100">
              {[
                ...
                <div key={b.label}>
                  <p className="text-2xl font-bold text-brand-primary">{b.val}</p>
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/5] max-w-md mx-auto lg:ml-auto">
              <Image
                src="/images/hero.jpg"
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 max-w-[220px]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-gray-800">İşitme Testi</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="section-title">İşitme sağlığınız için<br />kapsamlı çözümler</h2>
          </div>
            ...
            {services.map((s) => (
              <div key={s.title} className="card text-center group">
                <div className="w-14 h-14 rounded-2xl bg-teal-50 flex items-center justify-center mx-auto mb-5 group-hover:bg-brand-primary transition-colors duration-300">
                  <svg className="w-7 h-7 text-brand-primary group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {s.icon}
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-800 mb-3 text-lg">{s.title}</h3>
      ...
      <section className="py-24 bg-brand-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-500 mt-4">Dört basit adımda işitme sağlığınızı geri kazanın.</p>
          </div>
            ...
            {steps.map((step, i) => (
              <div key={step.num} className="relative">
                ...
                <div className="relative z-10">
                  <div className="text-5xl font-display font-bold text-teal-100 mb-4">{step.num}</div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Ücretsiz işitme testiniz için randevu talep edin.
                Ekibimiz en kısa sürede sizi arayacaktır.
              </p>
              <a href="tel:+905302406684" className="flex items-center gap-2 text-teal-300 hover:text-white transition-colors font-semibold">
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3">Adapazarı Devlet Hastanesi karşısı, Sakarya</p>
          </div>
