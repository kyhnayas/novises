...
const services = [
  {
    ...
    points: ["Ağrısız ve konforlu", "30 dakikada tamamlanır", "Sonuçlar hemen paylaşılır"],
  },
  {
    title: "Kişiselleştirilmiş Cihaz Seçimi",
    desc: "İşitme kaybınızın tipine, yaşam stilinize ve bütçenize göre en uygun cihazı birlikte seçiyoruz. Hiçbir baskı, yalnızca doğru bilgi.",
    img: "/images/service-device.jpg",
    points: ["Dünya markalarından seçenekler", "Deneme süresi imkânı", "Bütçeye uygun çözümler"],
  },
  {
    ...
    img: "/images/service-fitting.jpg",
    points: ["Özel yazılım programlama", "Kullanıcı eğitimi", "Uyum takip randevuları"],
  },
  {
    ...
    img: "/images/service-care.jpg",
    points: ["Profesyonel temizlik", "Pil ve aksesuar desteği", "Garanti kapsamı yönetimi"],
  },
];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="section-title text-4xl md:text-5xl mb-6">
              İşitme sağlığınız için<br />her adımda yanınızdayız
            </h1>
            <p className="text-gray-600 text-lg leading-relaxed">
              Testden cihaz takibine kadar tüm süreçleri tek çatı altında,
              uzman bir ekiple yürütüyoruz.
            </p>
          </div>
        </div>
      </section>
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                <h2 className="font-display text-3xl text-brand-dark mb-4">{s.title}</h2>
      ...
      <section className="py-20 bg-brand-light">
        <div className="max-w-2xl mx-auto text-center px-4">
          <h2 className="section-title mb-4">Hangi hizmete ihtiyacınız olduğundan emin değil misiniz?</h2>
          <p className="text-gray-600 mb-8">
            Sizi arayalım, birlikte konuşalım. Ücretsiz danışmanlık için randevu talep edin.
          </p>
