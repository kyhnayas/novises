    ...
    <>
      <section className="pt-32 pb-20 bg-brand-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="section-title text-4xl md:text-5xl mb-6">Bize ulaşın</h1>
          <p className="text-gray-600 text-lg max-w-2xl">
            Soru, öneri veya randevu talepleriniz için formu kullanabilir, doğrudan arayabilir ya da adresimizi ziyaret edebilirsiniz.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16">
          <div className="space-y-10">
            <div>
              <h2 className="font-display text-2xl text-brand-dark mb-6">İletişim Bilgileri</h2>
              <div className="space-y-5">
                {[
                  ...
                  {
                    label: "Adres",
                    value: "Güllük, Adnan Menderes Cd Sağlık Sk no:3 iç kapı 108, 54100 Adapazarı/Sakarya",
                  ...
                  <a key={c.label} href={c.href} target={c.label === "Adres" ? "_blank" : undefined} rel="noreferrer"
            ...
            <div className="rounded-2xl overflow-hidden h-56 border border-gray-100">
              <iframe
                ...
                referrerPolicy="no-referrer-when-downgrade" title="Novises Konum"
              />
            </div>
          </div>

          <div className="bg-brand-light rounded-3xl p-8 md:p-10 h-fit">
            <h2 className="font-display text-2xl text-brand-dark mb-2">Randevu / Mesaj</h2>
            <p className="text-gray-500 text-sm mb-8">Formu doldurun, en kısa sürede dönüş yapalım.</p>
            <AppointmentForm />
          </div>
        </div>
      </section>
